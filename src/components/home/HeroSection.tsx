...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] md:min-h-[85vh] flex items-center overflow-hidden pb-40 sm:pb-32 md:pb-16">
      {/* Background */}
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-primary-foreground space-y-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-heading font-bold leading-tight animate-fade-up">
              Powering Your{' '}
