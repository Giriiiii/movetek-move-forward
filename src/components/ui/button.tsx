  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-heading",
  {
    variants: {
      variant: {
        ...
        hero: "bg-ocean text-white border-none shadow-lg hover:shadow-xl hover:-translate-y-1 hover:bg-ocean-light",
        heroOutline: "border-2 border-white bg-navy/50 text-white hover:bg-white/20",
        navy: "bg-navy text-primary-foreground hover:bg-navy-light shadow-md hover:shadow-lg",
        ocean: "bg-ocean text-primary-foreground hover:bg-ocean-light shadow-md hover:shadow-lg hover:-translate-y-0.5",
      },
      size: {
